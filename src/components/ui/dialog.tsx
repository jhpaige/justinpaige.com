...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-md',
        'rounded-[22px] p-px',
        'bg-linear-to-br from-[rgba(124,92,255,0.45)] via-[rgba(45,226,230,0.2)] to-[rgba(255,255,255,0.06)]',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-sm text-white/65 leading-[1.6]', className)}
    {...props}
  />
));
...
const DialogFooter = ({
  ...
  <div className={cn('flex justify-end mt-5', className)} {...props} />
);
